...
--CACHE SIGNALS (ADD MORE TO ME!!)
  SUBTYPE LC3B_C_BOFFSET IS STD_LOGIC_VECTOR(3 DOWNTO 0); -- Byte Offset
  SUBTYPE LC3B_C_WOFFSET IS STD_LOGIC_VECTOR(2 DOWNTO 0); -- Word Offset
  ...
  SUBTYPE LC3B_tree     IS STD_LOGIC_VECTOR(6 DOWNTO 0);

	TYPE MEMORY_ARRAY_64K IS ARRAY (0 TO 65535) OF LC3B_BYTE;

	TYPE OPNAME IS (name_ADD, name_AND, name_BR, name_JSR, name_JMP, name_LDR, name_LDB, name_LDI, name_LEA, name_NOT, name_RET, name_RTI, name_SHF, name_STR, name_STB, name_STI, name_TRAP, name_NOP);
	...
	TYPE EX_Control IS RECORD
	    OffSel : LC3B_4MUX_SEL;
	    PCOffSel : std_logic;
	    ALUSel1 : LC3b_4Mux_Sel;
	    ALUSel2 : std_logic;
	    ALUop : LC3B_ALUOP;
      isSTB : std_logic;
      ExNeedsOp : std_logic;
	...
	TYPE MEM_Control IS RECORD
      ...
      mwriteL_L : std_logic;
      mread_L : std_logic;
      OneStepMem : std_logic;
      MemNotUsed : std_logic;
      isBR : std_logic;
      isNOTaNOP : std_logic;
      uncondBR  : std_logic;
	    AddrSel : std_logic;
	    BrAddrSel : std_logic;
	    IndirectMem : std_logic;
	    MemForwardEn : std_logic;
      MemNeedsOp : std_logic;
      RequestBaseR : std_logic;
      writeBTB : std_logic;
	END RECORD;

	TYPE WB_Control IS RECORD
	    SetCC : std_logic;
	    MemArSel : LC3b_4MUX_SEL;
      ld_Reg : std_logic;
      DestSel : std_logic;
      isLDB : std_logic;
	    WBForwardEn : std_logic;
	END RECORD;
	...
	CONSTANT DELAY_LATCH        : TIME := 3 NS;
