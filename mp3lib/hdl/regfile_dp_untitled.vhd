...
BEGIN
	...
	BEGIN
		...
		A_1 <= RAM(RADDR1) AFTER DELAY_REGFILE_READ;
		B_1 <= RAM(RADDR2) AFTER DELAY_REGFILE_READ;
	...
	BEGIN
		...
		A_2 <= RAM(RADDR1) AFTER DELAY_REGFILE_READ;
		B_2 <= RAM(RADDR2) AFTER DELAY_REGFILE_READ;
